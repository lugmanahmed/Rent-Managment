...
export default function ReportsPage() {
  ...
  const fetchReportData = async () => {
    try {
      ...
      const totalMaintenanceCosts = maintenanceCosts.reduce((sum: number, cost: any) => {
        return sum + (parseFloat(cost.repair_cost) || 0);
      }, 0);
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-gray-900">{reportData.period}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-blue-800 text-sm">{reportData.summary}</p>
                  </div>
